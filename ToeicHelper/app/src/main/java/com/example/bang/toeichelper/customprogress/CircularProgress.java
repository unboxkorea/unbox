package com.example.bang.toeichelper.customprogress;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.ThemeBlue);
        mColors[1] = context.getResources().getColor(R.color.ThemeOrange);
        mColors[2] = context.getResources().getColor(R.color.ThemeBrown);
        mColors[3] = context.getResources().getColor(R.color.ThemeYellow);
